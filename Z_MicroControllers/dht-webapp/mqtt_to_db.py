"""
MQTT subscriber — writes DHT sensor readings from Pico W and ESP32 to TimescaleDB.
Subscribes to both pico/# and esp32/# topics.
...
def on_connect(client, userdata, flags, rc):
    if rc == 0:
        ...
        print(f"Subscribed to: {[t for t, _ in TOPICS]}")
    else:
