...
# Raspberry Pi Project: Dht11, Python InfluxDB and Docker
...
I have build a docker image to run it with the tag **dht11_sensor_to_influxdb** at: <https://hub.docker.com/r/fossengineer/iot/tags>
